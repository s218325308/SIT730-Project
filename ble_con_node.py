...
MAC = "D4:D4:DA:4E:7E:2A"
TEMP_CHARACTERISTIC_UUID = "19B10001-E8F2-537E-4F6C-D104768A1214"
...
async def request_sensor_values(client, timeout=10):
    ...
    if client.is_connected:
        try:
            ...
            # Read the temperature and seat status data from the Arduino
            temp = await asyncio.wait_for(client.read_gatt_char(TEMP_CHARACTERISTIC_UUID), timeout)
            ...
            #sensor_data = {"temperature": temp, "seat_status": seat}
            sensor_data = f"{temp},{seat}"
